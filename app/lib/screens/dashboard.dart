                        ...
                        rows: [
                          DataRow(
                            cells: <DataCell>[
                              ...
                              DataCell(Text(snapshot.data![index].plot_size!)),
                              DataCell(Text(snapshot.data![index].bedrooms!)),
                              DataCell(Text(snapshot.data![index].bathrooms!)),
                              DataCell(
                                  Text(snapshot.data![index].living_space!)),
                              DataCell(Text(
                                  snapshot.data![index].broker_id.toString())),
                              DataCell(Text(snapshot.data![index].bathrooms!)),
                              DataCell(IconButton(
